...
public class ShikharSinha extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_pic = findViewById(R.id.shikhar_pic);
        ...
        player.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.cricbuzz.com/profiles/1446/shikhar-dhawan"));
                startActivity(intent);
            }
        });
        ...
        certificate_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/drive/folders/18H6X0WpEYl5PMOVtEcBb5H-rE77RTNbW"));
                startActivity(intent);
            }
        });
        ...
        FirebaseDatabase.getInstance().getReference("Players").child("shikharsinha").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(ShikharSinha.this).load(Uri.parse(image)).into(profile_pic);
