...
public class PraveenPushkar extends AppCompatActivity {
    ImageView pushkar_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_praveen_pushkar);
        ...
        profile_pic = findViewById(R.id.pushkar_pic);
        ...
        social1_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/PraveenPushkar"));
        ...
        social2_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://m.facebook.com/profile.php?id=1538470620"));
                startActivity(intent);
            }
        });
        ...
        ipl_team.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.mumbaiindians.com/"));
                startActivity(intent);
            }
        });
        ...
        player.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.cricbuzz.com/profiles/25/sachin-tendulkar"));
                startActivity(intent);
            }
        });
        ...
        certificate_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/drive/folders/15SwsEtxJUZteXHf3erWgR90_19M84PCR"));
                startActivity(intent);
            }
        });

        pushkar_back = findViewById(R.id.pushkar_back);
        pushkar_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pushkar_back.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY, HapticFeedbackConstants.FLAG_IGNORE_GLOBAL_SETTING);
                finish();
            }
        });
        ...
        FirebaseDatabase.getInstance().getReference("Players").child("praveenpushkar").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(PraveenPushkar.this).load(Uri.parse(image)).into(profile_pic);
