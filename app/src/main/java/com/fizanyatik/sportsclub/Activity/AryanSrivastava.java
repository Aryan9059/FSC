...
public class AryanSrivastava extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_pic = findViewById(R.id.aryan_pic);
        ...
        social1_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/aryan_srivastava"));
        ...
        ipl_team.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.delhicapitals.in/"));
                startActivity(intent);
            }
        });
        ...
        player.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.cricbuzz.com/profiles/308/gautam-gambhir"));
                startActivity(intent);
            }
        });
        ...
        certificate_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/drive/folders/13Hb_7XslpC-rfZ8NVDGs2LiOe8b7kjf3"));
                startActivity(intent);
            }
        });
        ...
        FirebaseDatabase.getInstance().getReference("Players").child("aryansrivastava").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(AryanSrivastava.this).load(Uri.parse(image)).into(profile_pic);
